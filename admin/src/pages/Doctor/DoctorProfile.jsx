          ...
          <p className="text-gray-600 font-medium mt-4">
            ...
            <span className="text-gray-800">
              ...
              {isEdit ? (
                <input
                  type="number"
                  className="bg-gray-100 border px-2 py-0.5 rounded outline-none"
                  onChange={(e) =>
          ...
          <div className="flex gap-2 py-2">
            ...
            <p className="text-sm text-gray-600">
              {isEdit ? (
                <input
                  type="text"
                  className="bg-gray-100 border px-2 py-0.5 rounded outline-none mb-1 block"
                  onChange={(e) =>
                    setProfileData((prev) => ({
                      ...prev,
              ...
              {isEdit ? (
                <input
                  type="text"
                  className="bg-gray-100 border px-2 py-0.5 rounded outline-none block"
                  onChange={(e) =>
                    setProfileData((prev) => ({
                      ...prev,
