      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-3">
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' :'hidden sm:flex'}`}>
          ...
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Dermatologis" ? "bg-indigo-100 text-black" : ""}`}
          >
            Dermatologis
          </p>
          <p
        ...
        <div className="w-full grid grid-cols-auto gap-4 gap-y-6">
          {filterDoc.map((item, index) => (
            <div
              ...
              key={index}
            >
              <img className="border-blue-50" src={item.image} alt="" />
              <div className="p-4">
